...
from .views import Home, Postdetail,NewPost,EditPost,DeletePost,Categorys,SectionView, EditProfileView, ViewAllcategories,ShowUserProfile, ViewLike,Viewaddcomment,about,upvote_comment,delete_comment,downvote_comment,contact_view
